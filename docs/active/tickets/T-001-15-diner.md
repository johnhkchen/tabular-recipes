...
Fill out the **Diner** menu. It currently holds **45 recipes, 17 of them its own** —
the rest are borrowed from other counters, which is legitimate but does not make a menu.

The soup section is the strongest on the site and the griddle is thin. Breakfast all day, and sandwiches and burgers, are both printed sections with nothing in them.

The work list is `docs/gaps/diner.md`, written after the whole collection was read as a set of
...
- **Diner** shelves at least **49 recipes**, of which at least **20** name it
  and no other counter.
- The dishes at the top of `docs/gaps/diner.md` are written, in that order, as far as the count
